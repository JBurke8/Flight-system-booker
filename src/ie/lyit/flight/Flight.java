...
public class Flight{
	...
	//    Flight fliteB = new Flight("BR215","Derry", "Stanstead", new Date(25,12,2018), new Time(12,40), 16.99);
	public Flight(String flightNumber, String source, String destination, Date date, Time time, double price){
